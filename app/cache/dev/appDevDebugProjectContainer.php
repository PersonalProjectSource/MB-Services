...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mb_user_extension' => 'getMbUserExtensionService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'mbservice_database', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/MB/AdminBundle/Entity'))), 'MB\\AdminBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('MBAdminBundle' => 'MB\\AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ed8630f49e460159d18ba84258922a807dd1b9f274961ea3f903db5385e056df');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('MB\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('MB\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('MB\\AdminBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('MB\\AdminBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'MB\\AdminBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'mb_user_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MB\AdminBundle\TwigExtension\UserManagerExtension A MB\AdminBundle\TwigExtension\UserManagerExtension instance.
     */
    protected function getMbUserExtensionService()
    {
        return $this->services['mb_user_extension'] = new \MB\AdminBundle\TwigExtension\UserManagerExtension();
    }
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        $o->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => true, 'use_referer' => true, 'default_target_path' => 'mb_admin_homepage', 'target_path_parameter' => '_target_path'));
        $o->setProviderKey('login');
        ...
        return $this->services['security.firewall.map.context.login'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'login', $a, $c), 2 => $n, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $m, 'login', $o, $p, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, $this->get('security.csrf.token_manager')), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5764e7bde94745.75994213', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'login', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $m, '/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('mb_user_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MB/MBServicesBundle/Resources/views'), 'MBMBServices');
        $instance->addPath(($this->targetDirs[3].'/src/MB/AdminBundle/Resources/views'), 'MBAdmin');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5492e041e6bed33c377c1f27b2baa7598f69a860');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MBMBServicesBundle' => 'MB\\MBServicesBundle\\MBMBServicesBundle',
                'MBAdminBundle' => 'MB\\AdminBundle\\MBAdminBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'mbservice_database',
            'database_user' => 'root',
            ...
            'secret' => '5492e041e6bed33c377c1f27b2baa7598f69a860',
            'locale' => 'fr',
            ...
            'kernel.secret' => '5492e041e6bed33c377c1f27b2baa7598f69a860',
            ...
            'fos_user.model.user.class' => 'MB\\AdminBundle\\Entity\\User',
