 ...
 */
class ContactMessage extends \MB\AdminBundle\Entity\ContactMessage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MB\\AdminBundle\\Entity\\ContactMessage' . "\0" . 'id', '' . "\0" . 'MB\\AdminBundle\\Entity\\ContactMessage' . "\0" . 'nom', '' . "\0" . 'MB\\AdminBundle\\Entity\\ContactMessage' . "\0" . 'prenom', '' . "\0" . 'MB\\AdminBundle\\Entity\\ContactMessage' . "\0" . 'objet', '' . "\0" . 'MB\\AdminBundle\\Entity\\ContactMessage' . "\0" . 'message', '' . "\0" . 'MB\\AdminBundle\\Entity\\ContactMessage' . "\0" . 'actif'];
        }
