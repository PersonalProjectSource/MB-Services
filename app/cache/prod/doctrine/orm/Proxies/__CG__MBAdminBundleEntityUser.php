 ...
 */
class User extends \MB\AdminBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'email', 'enabled', 'lastLogin', 'roles', 'usernameCanonical', 'emailCanonical', 'salt', 'password', 'plainPassword', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'credentialsExpired', 'credentialsExpireAt'];
        }
