...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'mbservice_database', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_74f77d55f9cb9295917345fc7da3030ba715f87743a71c20b469cadaef128b72');
    ...
    protected function getSecurity_Firewall_Map_Context_LoginService()
    {
        ...
        $o->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => true, 'use_referer' => true, 'default_target_path' => 'user_index', 'target_path_parameter' => '_target_path'));
